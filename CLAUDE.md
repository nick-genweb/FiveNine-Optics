...
**IMPORTANT**: Always use `/commit` for git commits - it handles version bumping automatically when CSS/JS files are modified.
...
- Package.json version is used for cache busting (`?v=1.0.3` on CSS/JS)
